...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 어짜피 filterApple에 두번째 매개값은 무조건 ApplePredicate 타입의 객체가 전달되어야 하는거고,
        // ApplePredicate는 추상메서드가 하나니까 굳이 메서드 이름을 쓸 필요가 없음.
        ...
        List<Character> map2 = map(foods, s -> s.charAt(0));
